...
(function () {
  ...
  var FOOTER_HTML =
    ...
    '<a href="index.html"><i class="bi bi-house-door"></i> Home</a><a href="about.html"><i class="bi bi-info-circle"></i> About Us</a><a href="key-managerial-personnel.html"><i class="bi bi-people"></i> Key Managerial Personnels</a><a href="feedback.html"><i class="bi bi-chat-left-text"></i> Feedback &amp; Queries</a><a href="contact-us.html"><i class="bi bi-telephone"></i> Contact Us</a><a href="branches.html"><i class="bi bi-geo-alt"></i> Office Addresses</a><a href="new-downloads.html"><i class="bi bi-download"></i> New Downloads</a></div>' +
    '<div class="footer-col"><h5>Downloads &amp; Forms</h5>' +
    '<a href="https://api.marfatia.net/api/files/NEWKYCFORM 1.pdf" target="_blank" rel="noopener"><i class="bi bi-file-earmark-person"></i> Client Reg. Form (KYC)</a><a href="new-downloads.html"><i class="bi bi-folder2-open"></i> Download Forms Area</a><a href="https://api.marfatia.net/api/files/VERNACULAR_LANGUAGES.pdf" target="_blank" rel="noopener"><i class="bi bi-translate"></i> Vernacular Languages</a><a href="https://api.marfatia.net/api/files/StepbyStep-Procedure-for-Account-opening.pdf" target="_blank" rel="noopener"><i class="bi bi-book"></i> eKYC Step-by-Step Guide</a></div>' +
    '<div class="footer-col"><h5>Compliance &amp; Legal</h5>' +
    '<a href="investor-charter-stockbroker.html"><i class="bi bi-award"></i> Investor Charter – Stock Broker</a><a href="investor-charter-dp.html"><i class="bi bi-shield-check"></i> Investor Charter – Depository Participant</a><a href="investor-charter-pms.html"><i class="bi bi-pie-chart"></i> Investor Charter – Portfolio Manager</a><a href="investor-charter-research-analyst.html"><i class="bi bi-person-lines-fill"></i> Investor Charter Research Analyst</a><a href="dos-and-donts.html"><i class="bi bi-check2-circle"></i> Do’s &amp; Don’ts</a><a href="privacy-policy.html"><i class="bi bi-shield-lock"></i> Privacy Policy</a><a href="terms-of-use.html"><i class="bi bi-file-earmark-check"></i> Terms &amp; Conditions</a><a href="disclaimer.html"><i class="bi bi-file-earmark-break"></i> Disclaimer Policy</a><a href="https://api.marfatia.net/api/files/Policies and circular.pdf" target="_blank" rel="noopener"><i class="bi bi-file-earmark-text"></i> Policies and Circulars</a><a href="https://api.marfatia.net/api/files/MSBPL_PMS_Doslosure_Document-Oct_2024.pdf" target="_blank" rel="noopener"><i class="bi bi-journal-text"></i> PMS Disclosure Document</a><a href="advisory-for-investors.html"><i class="bi bi-megaphone"></i> Advisory for Investors</a><a href="advisory-kyc-compliance.html"><i class="bi bi-clipboard-check"></i> Advisory — KYC Compliance</a><a href="exchange-sebi-registration.html"><i class="bi bi-card-checklist"></i> Exchange/SEBI Registration Details</a><a href="' + LINKS.odr + '" target="_blank" rel="noopener"><i class="bi bi-cpu-fill"></i> Smart ODR Portal &#x2197;</a><a href="' + LINKS.scores + '" target="_blank" rel="noopener"><i class="bi bi-safe"></i> SEBI SCORES &#x2197;</a></div>' +
    '</div>' +
